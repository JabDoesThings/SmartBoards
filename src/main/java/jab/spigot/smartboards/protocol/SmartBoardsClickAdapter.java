...
public class SmartBoardsClickAdapter extends PacketAdapter {
   ...
   */
  public SmartBoardsClickAdapter(@NotNull SmartBoardThread thread, @NotNull JavaPlugin plugin) {
    super(
        plugin,
  ...
  private boolean handleBlockDig(@NotNull Player player, @NotNull PacketPlayInBlockDig packet) {
    ...
    SmartBoardSearch search = thread.getBoardAndUVLookedAt(player, 12);
